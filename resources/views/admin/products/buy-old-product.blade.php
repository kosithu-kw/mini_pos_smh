            ...
            <div class="col-md-6 col-md-offset-3">
                <form method="post" action="{{route('update.old.item.buy')}}">
                    ...
                    <div class="form-group @if($errors->has('sale_price_1')) has-error @endif ">
                        ...
                        <input type="number" name="sale_price_1" id="sale_price_1" class="form-control" value="{{$pd->sale_price_1}}">
                    ...
                    <div class="form-group @if($errors->has('sale_price_2')) has-error @endif ">
                        ...
                        <input type="number" name="sale_price_2" id="sale_price_2" class="form-control" value="{{$pd->sale_price_2}}">
